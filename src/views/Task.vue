            ...
            <div class="row">
              ...
              <div class="input-field">
                ...
                <span class="character-counter"
                      style="float: right;font-size: 12px;">{{ description.length }}/400</span>
              </div>
              <div class="input-field">
              ...
              <div class="" v-if="task.status !== 'completed'">
                ...
                <button class="blue btn-large" type="submit" style="margin-left:1rem;" @click="completeTask">Complete
                  Task
                </button>
              </div>
            </div>
